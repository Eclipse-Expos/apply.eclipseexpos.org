...
/**
 * Calculates the counter max based on the star count.
 * @param starCount The star count.
 * @returns The counter max.
 */
export function calculateCounterMax(starCount: number) {
  const counterMax = (starCount * starCount) / 3;
